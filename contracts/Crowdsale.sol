...
contract Crowdsale is ReentrancyGuard {
    ...
    constructor(
        ...
        require(pRate > 0, "Crowdsale: rate is 0");
        require(pWallet != address(0), "Crowdsale: wallet is the zero address");
        require(
